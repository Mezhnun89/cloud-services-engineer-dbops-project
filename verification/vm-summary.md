...
Сводка на 06.09.2026 составлена по выводу команд, присланному пользователем из SSH-сеанса. Полные журналы получены в архиве пользователя и добавлены в этот каталог. Контрольные суммы четырёх миграций совпали с файлами в репозитории; CSV до/после совпали побайтно.

Основные доказательства: [автотесты](practicum-autotests.log), [данные и FK](v003-data.log), [V004 и индексы](v004-indexes.log), [план до индексов](before-indexes.log), [план после индексов](after-indexes.log), [контрольные суммы](migration-sha256.txt).
